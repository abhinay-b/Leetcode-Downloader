...
#         print('subid:',sub_id)
        ...
        sleep(6)
        if len(driver.find_elements_by_xpath("/html/body/div[1]/div[4]/div[1]/div/div[1]/h4/a")) > 0:
            prog_name = driver.find_elements_by_xpath("/html/body/div[1]/div[4]/div[1]/div/div[1]/h4/a")[0].text
